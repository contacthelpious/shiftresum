            ...
            {experience?.map(exp => (
              <div key={exp.id}>
                ...
                <ul className="list-disc list-outside pl-5 space-y-1">
                  {exp.description?.map((item) => item.value.trim() && <li key={item.id} className="text-sm">{item.value}</li>)}
                </ul>
              </div>
            ))}
          </div>
                        ...
                        {experience?.map(exp => (
                            <div key={exp.id}>
                                ...
                                <ul className="list-disc list-outside pl-4 space-y-1 text-sm">
                                    {exp.description?.map((item) => item.value.trim() && <li key={item.id}>{item.value}</li>)}
                                </ul>
                            </div>
                        ))}
                    </div>
